...
# Target: program_aq_so3_kernel_galerkin.py
...
while (-not $success) {
    ...
    cd $SrcDir
    tar.exe -czf "payload_aq.tar.gz" program_aq_so3_kernel_galerkin.py
    ...
    $RunCmd = "export OMP_NUM_THREADS=64; cd $RemoteDir/emergent_quantum_geometries; nohup python3 -u program_aq_so3_kernel_galerkin.py --n-centers 500 1000 2000 5000 10000 --N-truncation 5 10 15 20 --oversampling-ratios 10 > $LogFile 2>&1 &"
