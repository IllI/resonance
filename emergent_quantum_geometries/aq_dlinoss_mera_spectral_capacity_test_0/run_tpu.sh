...
OUTPUT=${2:-$ROOT/results/mera_spectral_capacity_test_1_tpu.json}
export JAX_PLATFORMS=tpu
export JAX_COMPILATION_CACHE_DIR=${JAX_COMPILATION_CACHE_DIR:-$HOME/.cache/jax/mera_spectral_capacity_1}
