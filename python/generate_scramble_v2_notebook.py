"""
generate_scramble_v2_notebook.py
Generates Chronos_Scramble_v2.ipynb with IQSP-informed protocol.
Run locally: python python/generate_scramble_v2_notebook.py
"""
import json, pathlib

def code_cell(src): return {"cell_type":"code","execution_count":None,"metadata":{"id":""},"outputs":[],"source":src}
def md_cell(src):   return {"cell_type":"markdown","metadata":{"id":""},"source":src}
...
# ── Cell 3 · Per-Machine Calibration ─────────────────────────────────────────
cells.append(code_cell([
...
# ── Cell 4 · λ-Schedule and Gaussian Profile ─────────────────────────────────
cells.append(code_cell([
...
# ── Cell 5 · TPU pmap Engine + Capture Loop ──────────────────────────────────
cells.append(code_cell([
...
# ── Cell 6 · Manifest + Package + Download ────────────────────────────────────
cells.append(code_cell([
...
nb = {
    ...
    "metadata": {
        "accelerator": "TPU",
        "colab": {"name": "Chronos_Scramble_v2.ipynb", "provenance": []},
        "kernelspec": {"display_name": "Python 3", "name": "python3"},
        "language_info": {"name": "python"},
    },
    "cells": cells,
}
out = pathlib.Path("Chronos_Scramble_v2.ipynb")
