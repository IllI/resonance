...
def test_basic_3d_rendering():
    ...
    try:
        ...
        try:
            ...
            print(f"⚠️ Isosurface extraction failed: {e}")
...
def test_qt_integration():
    ...
    try:
        ...
        try:
            ...
            print(f"⚠️ PyVistaQt test failed: {e}")
            return False
    ...
    try:
        ...
        try:
            ...
            if processing_time < 5.0:  # Should be fast with GPU
                ...
                print("⚠️ Processing slower than expected - may need GPU optimization")
                
        except Exception as e:
            print(f"⚠️ Large dataset processing failed: {e}")
