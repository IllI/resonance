...
def test_fmri_time_series_processing():
    ...
    try:
        ...
        if len(detections) > 0:
            ...
            print("       No ROIs detected (may be due to random data)")
    ...
    try:
        ...
        for subject_id in range(n_subjects):
            ...
            if success and n_rois > 0:
                ...
                print(f"          No features from subject {subject_id + 1}")
        ...
        if len(all_features) > 0:
            ...
            if min_class_count >= 2 and len(y) >= 10:
                ...
                print("       Insufficient data for proper splitting - would use mock accuracy")
