"""
generate_scramble_notebook.py — run once locally to produce the Colab notebook.
"""
import json, pathlib
...
# ── Cell 1 · Config (Colab form / dropdown) ─────────────────────────────────
...
# ── Cell 3 · Detector and timing kernel ─────────────────────────────────────
cells.append(code_cell([
...
nb = {
    ...
    "metadata": {
        "accelerator": "GPU",
        "colab": {
            "name": "Chronos_Scramble_Trigger_Experiment.ipynb",
            "provenance": []
        },
...
out = pathlib.Path("Chronos_Scramble_Trigger_Experiment.ipynb")
